...
------1. Display the Highest, Lowest, Label the columns Maximum, Minimum respectively.-----SELECT MAX(SALARY) AS HIGH_SALARY, MIN(SALARY) AS MIN_SALARY FROM EMP
